...
To measure which pages and advertisements lead to enquiries, the Google tag also records when an enquiry, a plan from the setup planner or a newsletter sign-up is sent, and when a "Book a call" link is clicked, in the same way as other page activity described above. These records never include anything you type into a form.
