...
order: 2
outcome: "Gesetzliche Einreichungen, Register und Beschlüsse, Jahr für Jahr termingerecht erledigt."
headline: "Eine Gesellschaft, die regelkonform bleibt, ohne dass Sie ihr hinterherlaufen müssen."
intro: "Jede Gesellschaft in Singapur schuldet ACRA (der Handelsregisterbehörde Singapurs) einen jährlichen Zyklus aus Registern, Beschlüssen, Versammlungen und Einreichungen, und ein Bußgeldbescheid ist meist das erste Anzeichen dafür, dass etwas übersehen wurde. Meridium trägt den gesamten Zyklus: Ihr fester Ansprechpartner behält die Fristen im Blick, bereitet die Unterlagen vor und reicht termingerecht ein, Jahr für Jahr."
ctaNoun: "die laufende Betreuung Ihrer Gesellschaft"
seoTitle: "Company Secretarial Services in Singapur | Meridium"
seoDescription: "Annual Returns, AGMs, gesetzliche Register, Kapitalmaßnahmen und Gesellschaftsschließungen, betreut von erfahrenen Praktikern in Singapur."
included:
...
process:
  - title: "Übernahmeprüfung"
    description: "Wir prüfen die Gesellschaftsunterlagen im vorgefundenen Zustand, markieren alles Überfällige oder Widersprüchliche und bereinigen die Akte, bevor daraus ein Problem wird."
  - title: "Compliance-Kalender"
    description: "Jede gesetzliche Frist Ihres Geschäftsjahres wird erfasst und liegt in der Verantwortung Ihres festen Ansprechpartners. Sie sehen den Kalender, wir führen ihn."
  - title: "Änderungen, sobald sie anfallen"
    description: "Neuer Direktor, neuer Gesellschafter, neue Adresse, neue Anteilsklasse: Sie teilen uns die Entscheidung mit, wir bereiten die Beschlüsse vor und reichen bei ACRA ein."
  - title: "Jahresabschlusszyklus"
    description: "Die Jahresabschlüsse werden an die Gesellschafter versandt, die AGM wird abgehalten oder förmlich entbehrlich gemacht, und der Annual Return wird fristgerecht eingereicht."
needs:
...
faqs:
  - q: "Muss eine private Gesellschaft weiterhin eine AGM abhalten?"
    a: "Nicht immer. Eine private Gesellschaft kann auf die AGM verzichten, wenn die Jahresabschlüsse den Gesellschaftern innerhalb von fünf Monaten nach Ende des Geschäftsjahres zugesandt werden und kein Gesellschafter eine Versammlung verlangt. Wir beraten, welcher Weg passt, und bereiten in beiden Fällen die Unterlagen vor."
  - q: "Wann ist der Annual Return fällig?"
    a: "Für eine private Gesellschaft mit einem Geschäftsjahr, das am oder nach dem 31. August 2018 endet, muss der Annual Return innerhalb von sieben Monaten nach Ende des Geschäftsjahres eingereicht werden. Wir erledigen dies im Rahmen des Jahresabschlusszyklus, sodass Sie sich die Frist nie selbst merken müssen."
...
related:
  ...
  label: "Firmengründung: die Errichtung der Gesellschaft, die dieser Service anschließend laufend betreut"
---
