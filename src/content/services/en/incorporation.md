...
process:
  - title: "Scoping call"
    description: "A senior adviser confirms the right structure for your plans, the statutory roles you will need, and a fixed fee for the work."
  - title: "KYC and documents"
    description: "We complete identity and compliance checks on directors, shareholders and beneficial owners, and prepare every document for signature."
  - title: "Filing with ACRA"
    description: "We reserve the company name and file the incorporation. You receive the company number and full corporate record as soon as the entity is live."
  - title: "Post-incorporation setup"
    description: "Bank account application, appointment of the secretary, first resolutions, and handover of your compliance calendar to your named senior contact."
needs:
...
faqs:
  - q: "Do I need to travel to Singapore to incorporate?"
    a: "No. Incorporation itself can be completed remotely. Some banks prefer to meet directors in person before opening an account, and we advise you on which banks suit a remote setup before you commit to travel."
  - q: "Can a foreign person or company own 100 per cent of a Singapore company?"
    a: "Yes. Singapore places no restriction on foreign shareholding in a private limited company. The residency requirement applies to directors, not to shareholders."
  - q: "What does a nominee director actually do, and not do?"
    a: "A nominee director satisfies the legal requirement for a locally resident director and carries statutory responsibility for the company's compliance. A nominee does not manage the business, does not hold shares, is not a signatory on your bank account and takes no part in commercial decisions. Control stays with you."
  - q: "How long does incorporation take?"
    a: "Once KYC is complete and documents are signed, the filing itself is usually quick. Name approval can take longer if the name is referred to another government agency for review. We give you a realistic timeline at the scoping call rather than a marketing number."
  - q: "How much share capital do I need?"
    a: "A company can be incorporated with share capital of one Singapore dollar. The right figure for you depends on what the company will do: some licence applications and work pass applications weigh paid-up capital, and some customers and landlords read it as a signal. We advise on this at scoping."
  - q: "What happens after incorporation?"
    a: "The entity immediately owes Singapore an annual cycle of obligations: registers kept current, resolutions recorded, the annual return filed and the AGM held where one is still required. Our company secretarial service carries that cycle for you, with the same named contact."
related:
  slug: "en/company-secretarial"
  label: "Company secretarial: the ongoing statutory work after incorporation"
---
